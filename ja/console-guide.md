...
##### 制約事項
* アラームルールの対象複製グループに複製グループを1つだけ入力し、その複製グループを複製グループ画面から削除した場合、アラームは唯一の対象複製グループがなくなった関係で、今後はすべての複製グループを対象として認識します。
* アラームルールの受信グループに受信グループを1つだけ入力し、その受信グループを受信グループ詳細画面から削除した場合、アラームは唯一の受信グループがなくなった関係で今後はアラームを送れなくなります。
* 複製グループ作成のアラームは、対象複製グループがあってもすべての複製グループが対象になりアラームを送ります。

## イベント

* EasyCache > イベントタブを選択します。
* EasyCacheは、複製グループで発生した意味のあるイベントを自動的に記録します。
